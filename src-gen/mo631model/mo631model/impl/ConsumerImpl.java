 ...
 *   <li>{@link mo631model.mo631model.impl.ConsumerImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConsumerImpl extends MinimalEObjectImpl.Container implements Consumer {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mo631modelPackage.CONSUMER__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case Mo631modelPackage.CONSUMER__QUEUE:
			return getQueue();
		case Mo631modelPackage.CONSUMER__NAME:
			return getName();
		}
